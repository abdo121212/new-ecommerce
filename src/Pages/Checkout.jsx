...
export default function Checkout() {
  ...
  async function createCashOrder(values) {
    let toastLoading = toast.loading("Waiting", { position: "top-center" });
    try {
      const options = {
      ...
      toast.dismiss(toastLoading, { position: "top-center" });
    }
  }
  ...
  return (
    <>
      ...
      <section className="container px-10 mx-auto w-full  py-5">
        <h1 className="font-bold text-2xl">Shipping Address</h1>
        <form className="py-5 space-y-5 " onSubmit={formik.handleSubmit}>
          <div className="city">
            <input
              className="border-solid border-main focus:ring-0 focus:shadow-none focus:outline-none focus:border-main border-b-2 w-full"
              type="text"
          ...
          <div className="phone">
            <input
              className="border-solid border-main focus:ring-0 border-b-2 w-full focus:outline-none focus:border-main "
              type="tel"
          ...
          <div className="btns flex gap-3 items-center flex-wrap  ">
            <button
              ...
              type="submit"
              className=" bg-blue-600 hover:bg-blue-700 duration-300 transition-colors px-3 py-2 text-white rounded-2xl cursor-pointer"
            >
              Cash Order
            </button>
            <button
              ...
              type="submit"
              className=" bg-main cursor-pointer text-white duration-300 transition-colors px-3 py-2 rounded-2xl"
            >
              Online Payment
            </button>
          </div>
